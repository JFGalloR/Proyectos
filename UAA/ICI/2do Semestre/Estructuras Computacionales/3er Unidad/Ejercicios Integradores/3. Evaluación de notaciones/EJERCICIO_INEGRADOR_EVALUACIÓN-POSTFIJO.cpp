/*===========================================================================================================
	EJERCICIO INTEGRADOR UNIDAD III. Evaluación se Notación de Postfijo.
  ---------------------------------------------------------------------------------------------------------
	• OBJETIVO:
		Realizar un algoritmo para la evaluación de expresión de Notación de Postfijo implementado 
		en PILAS.
  ---------------------------------------------------------------------------------------------------------
    • ELABORADORES:
...
//========================================================= FUNCIÓN PARA EVALUAR LA EXPRESIÓN A POSTFIJO =====
/*-----------------------------------------------------------------------------------------------------------
	Función que nos hace el proceso de evaluación de la expresión en postfijo.
  ---------------------------------------------------------------------------------------------------------*/
...
main()
{
	...
	do
	{
		// Texto de control.
		system("cls");
		color(ROJ, GRIC);cout<<"                                       EVALUACIÓN (Postfijo)                                       "<<endl<<endl<<endl;
		...
		if(cadMayus(exp) != "SALIR")
		{
			...
			if(comprobar(exp))
			{
				...
				color(GRIC, ROJ);cout<<endl<<"\t==== POSTFIJO    ==================================="<<endl<<endl;
				color(GRIC, NEG);cout<<"\t     ";
				for(int i = 0; i < exp.size(); i++)
				{
